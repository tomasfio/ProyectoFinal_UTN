	...
	public static Connection getConnection()
	{
		try {
			if(con == null)
			{
				...
				String url = "jdbc:mysql://localhost:3306/proyecto_final?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"; //rb.getString("url");
